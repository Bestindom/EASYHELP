...
<style scoped>
.provider-container {
  overflow-x: auto; /* Agregar barra de desplazamiento horizontal */
  white-space: nowrap; /* Para que los elementos no se envuelvan */
}

.providers {
  display: inline-flex; /* Mostrar los elementos en una línea */
